  ...
  theme: {
    extend: {
      backgroundImage: {
        ...
        'bg-kessel2': "radial-gradient(circle, rgba(238,174,202,0) 10%, rgba(1,2,3,1) 43%), url('https://plexus.baltic-galaxy.de/assets/baltic/kessel.png')",
        ...
        'gradient-blog-post-header': "linear-gradient(0deg, #010203 22.38%, rgba(1, 2, 3, 0) 64.2%), linear-gradient(180deg, rgba(1, 2, 3, 0.9) 0%, rgba(1, 2, 3, 0) 100%)",
      },
      backgroundColor: {
        'bal-blue': '#0d1116',
        'baltic-tuerkis': '#00FFB2',
        'bal-yellow': '#EECE88',
        'bal-yellow-darker': '#FFC442',
      },
      textColor: {
        'baltic-tuerkis': '#00FFB2',
        'bal-blue': '#7E89B1',
