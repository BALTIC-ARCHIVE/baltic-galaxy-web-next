                        ...
                        <div>
                            <ul className="mt-2 list-disc">
                                <li className="inline mx-5">
                                    <a href="https://www.baltic-studios.net/privacy" className="hover:text-gray-400 text-gray-500 hover:cursor-pointer">
                                        Datenschutz
                                    </a>
                                </li>
                                <li className="inline mx-5">
                                    <a href="https://www.baltic-studios.net/imprint" className="hover:text-gray-400 text-gray-500 hover:cursor-pointer">
                                        Impressum
                                    </a>
                                </li>
{/*                                <li className="inline mx-5">
